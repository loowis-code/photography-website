...
- [x] **11. Add E2E tests (Playwright)** (~2-3 days) — Auth flow, image upload, CRUD, search
...
- [x] **25. Add visible focus states to all interactive elements** (~2 hrs) — CSS modules throughout
