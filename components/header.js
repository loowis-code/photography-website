        ...
        <div className={styles.header}>
            ...
            <div className={styles.navs}>
                ...
                <div className={styles.navlink}>
                    <div className="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Collections</div>
                    <ul className="dropdown-menu">
                        {data.map((d) => (<li><a className="dropdown-item" href={`/collections/${d.data.collection_id}`}>{d.data.collection_name}</a></li>))}
                    </ul>
                </div>
            </div>
        </div>
