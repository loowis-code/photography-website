    ...
    async function getLatestPhotos() {
        ...
        photoData.forEach(function (photo) {
            if (photo.data.featured === "on") {
                featured.push({filename: photo.data.filename, url_id: photo.data.url_id, title: photo.data.title});
            }
        });
        ...
        let recent = [];
        photoData.forEach(function (photo) {
            recent.push({filename: photo.data.filename, url_id: photo.data.url_id, title: photo.data.title});
